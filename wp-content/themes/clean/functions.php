...
function clean_scripts() {
	...
	wp_enqueue_style( 'clean-style-font1', 'http://fonts.googleapis.com/css?family=Roboto:400,300,100,500');
	wp_enqueue_style( 'clean-style-font1', 'http://fonts.googleapis.com/css?family=Roboto+Slab:400,300,100,500');
	wp_enqueue_style( 'clean-amimate-style', get_template_directory_uri(). '/assets/css/animate.css');
